...
type Interface interface {
	...
	Find(ctx context.Context, collection string, entity any, filter any, opts ...*options.FindOptions) error
	FindOne(ctx context.Context, collection string, dest any, filter any, opts ...*options.FindOneOptions) error
...
func (m *mongoDB) Close(ctx context.Context) error {
	if ctx.Err() != nil {
		return errors.NewWithCode(codes.CodeNoSQLClose, "context already cancelled: %v", ctx.Err())
	}
...
func (m *mongoDB) Find(ctx context.Context, collection string, dest any, filter any, opts ...*options.FindOptions) error {
...
func (m *mongoDB) FindOne(ctx context.Context, collection string, dest any, filter any, opts ...*options.FindOneOptions) error {
...
func (m *mongoDB) InsertOne(ctx context.Context, collection string, data any) (*mongo.InsertOneResult, error) {
...
func (m *mongoDB) UpdateOne(ctx context.Context, collection string, filter any, update any, opts ...*options.UpdateOptions) (*mongo.UpdateResult, error) {
...
func (m *mongoDB) UpdateMany(ctx context.Context, collection string, filter any, update any, opts ...*options.UpdateOptions) (*mongo.UpdateResult, error) {
