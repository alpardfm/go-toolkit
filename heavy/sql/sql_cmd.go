...
type Command interface {
	...
	QueryIn(ctx context.Context, name string, query string, args ...any) (*sqlx.Rows, error)
	QueryRow(ctx context.Context, name string, query string, args ...any) (*sqlx.Row, error)
	Query(ctx context.Context, name string, query string, args ...any) (*sqlx.Rows, error)
	NamedQuery(ctx context.Context, name string, query string, arg any) (*sqlx.Rows, error)
	Prepare(ctx context.Context, name string, query string) (CommandStmt, error)

	NamedExec(ctx context.Context, name string, query string, args any) (sql.Result, error)
...
func (c *command) In(query string, args ...any) (string, []any, error) {
...
func (c *command) QueryIn(ctx context.Context, name string, query string, args ...any) (*sqlx.Rows, error) {
...
func (c *command) QueryRow(ctx context.Context, name string, query string, args ...any) (*sqlx.Row, error) {
	row := c.db.QueryRowxContext(ctx, query, args...)
	return row, row.Err()
}

func (c *command) Query(ctx context.Context, name string, query string, args ...any) (*sqlx.Rows, error) {
	return c.db.QueryxContext(ctx, query, args...)
}

func (c *command) NamedQuery(ctx context.Context, name string, query string, arg any) (*sqlx.Rows, error) {
...
func (c *command) NamedExec(ctx context.Context, name string, query string, args any) (sql.Result, error) {
	return c.db.NamedExecContext(ctx, query, args)
}

func (c *command) Exec(ctx context.Context, name string, query string, args ...any) (sql.Result, error) {
